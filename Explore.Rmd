...
# Summary output on base model
summary(edu_coxph)
```

Our base model is significant ..... 
**YAY, ELABORATE ON OUTPUT HERE**

## Controling for Racial Makeup
...
blog <- ggplot(divorce, mapping = aes(time = years, status = div, color = edu)) +
...
#   theme(legend.title = element_blank())
#####
#plot_grid(blog, clog,nrow = 2, ncol = 2, label_size = 10)
blog
