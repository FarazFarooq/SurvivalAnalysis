...
b = paste("Edu + Husband_Race =", round(eh_BIC, r))
c = paste("Edu + Mixed =", round(em_BIC, r))
d = paste("Edu + Mixed + Husband_Race =", round(emb_BIC, r))
e = paste("Edu + Mixed + Husband_Race + Wife_Race =", round(embw_BIC, r))
f = paste("Edu + Couple =", round(edu_couple_BIC, r))

neatPrint(c(a,b,c,d,e,f))
```

Although the BIC on the model using education and mixed couple was the lowest, we decided to continue our analysis using a new variable, "couple" which encodes all the racial makeups into one predictor. Below, we test the difference between the two models to ensure there is no statistical difference.
...
# Check PH assumption, BIC, ...likelihood ratio test?
