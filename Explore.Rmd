...
<<<<<< interpet plots here >>>>>>
Note that y axos min is at 0.3, and you need to look closely at the y axis to see the difference in curves.

## Time Transform

Observations split on time == 47, we will use this time transformation (instead of the more involved approach) because it does not introduce a new $\beta$.
